<template>
  <button
    ...
    :class="
      cn(
        'group relative w-auto cursor-pointer overflow-hidden rounded-full border border-black dark:border-white bg-background p-2 px-6 text-center font-semibold',
        props.class,
      )
    "
  >
    ...
    >
      <span class="whitespace-nowrap dark:text-black text-white">{{ text }}</span>
      <svg
        ...
        class="lucide lucide-arrow-right dark:text-black text-white"
      >
        <path d="M5 12h14" />
